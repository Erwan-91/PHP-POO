<?php
    /*La pratique veut que l'on affiche un objet dans une page differente que celle de la class. La classe se trouve dans un fichier externe; il prendra une majuscule et qui devra être nommer du nom de la class ex: Class.php */
