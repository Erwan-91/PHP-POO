...
<head>
    <title>L'héritage  - cours programmation orienté objet</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p>L'héritage est une notion essentielle en orienté objet. En effet, on peut avoir besoin de changer certains paramètres d'une classe et en garder d'autres. <br>
                
            
                Exemple : Class Magicien extends Personnage <br>
                C'est à ce moment qu'intervient la notion d'héritage. Elle va permettre de dire dans une nouvelle classe qu'on hérite d'une ancienne. Celle-ci aura donc accès à toutes les propriétés et méthodes public et protected de notre classe initiale.</p>


                <h2 class="texte-secondary texte-center">Les avantages</h2>
                <p>L'héritage va nous permettre, nous seulement de garder une organisation optimale pour le code, mais aussi d'avoir le moins de répétitions possible. Un autre avantage est que l'on peut redéfinir des propriétés à la volée. Alors que dans la classe parente de Personnage.php les attaques sont à 20, dans la nouvelle classe que nous avons créée, nous allons pouvoir définir les attaques à 40 sans pour autant devoir réécrire (ou copier-coller) le reste du code</p>



                <h2 class="text-secondary text-center">Utilisation</h2>
                <p>Pour qu'une classe hérite d'une autre, il suffira d'écrire, après l'habituel <code>class Nomclass</code> d'écrire le mot "extends" suivi de la classe dont on veut hériter. Cette façon de faire permet d'instancier un personnage qui aura peut être des nouvelles propriétés ou méthodes grâce à notre nouvelle classe. </p>
